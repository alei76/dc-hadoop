...
public class NDayLostRateGuankaReducer extends Reducer<OutFieldsBaseModel, OutFieldsBaseModel, OutFieldsBaseModel, OutFieldsBaseModel> {
	...
	protected void reduce(OutFieldsBaseModel key, Iterable<OutFieldsBaseModel> values, Context context) throws IOException, InterruptedException {
		...
		for(OutFieldsBaseModel val : values){
			...
			String lostFlag = val.getOutFields()[1];
			if("Y".equals(newFlag)){
				newPlayers++;
			}
			if("Y".equals(lostFlag)){
				NL7Players++;
			}
		}
