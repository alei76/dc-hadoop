 ...
 *
 */
public class EventSeparator2Mapper extends Mapper<LongWritable, Text, Text, OutFieldsBaseModel> {
	...
	protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
		...
		valObj.setOutFields(eventLog.toOldVersionArr());
		...
		context.write(keyObj, valObj);
			...
			System.out.println("EVENT_ERROR---valObj="+valObj.toString());
		}
	}
}
