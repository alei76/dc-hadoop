...
public class H5OnlineDayForPlayerDeviceMapper extends Mapper<LongWritable, Text, OutFieldsBaseModel, OutFieldsBaseModel> {
	...
	protected void map(LongWritable key, Text value, Context context)
		...
		boolean isNewPlayer = onlineLog.isH5NewAddPlayer(statDate) 
			   	? true 
				: false;
		
		String playerType = Constants.DATA_FLAG_PLAYER_ONLINE; // 只是活跃
		if (isNewPlayer) { // 新增、活跃
