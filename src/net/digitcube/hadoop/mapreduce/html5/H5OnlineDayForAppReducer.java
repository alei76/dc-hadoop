...
public class H5OnlineDayForAppReducer extends Reducer<OutFieldsBaseModel, OutFieldsBaseModel, OutFieldsBaseModel, OutFieldsBaseModel> {
	...
	protected void reduce(OutFieldsBaseModel key, Iterable<OutFieldsBaseModel> values, Context context) throws IOException, InterruptedException {
		...
		key.setSuffix(Constants.SUFFIX_H5_ONLINEDAY_FOR_APP);
