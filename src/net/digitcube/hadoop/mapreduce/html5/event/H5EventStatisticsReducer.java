...
/**
 * see @H5EventStatisticsMapper
 * 
 */

public class H5EventStatisticsReducer extends Reducer<OutFieldsBaseModel, OutFieldsBaseModel, OutFieldsBaseModel, OutFieldsBaseModel> {
	...
	protected void reduce(OutFieldsBaseModel key, Iterable<OutFieldsBaseModel> values, Context context) throws IOException, InterruptedException {
		...
		if(Constants.SUFFIX_H5_EVENT_STAT.equals(key.getSuffix())){  //事件统计
		...
		}else if(Constants.SUFFIX_H5_EVENT_ATTR_STAT.equals(key.getSuffix())){	//事件属性统计
