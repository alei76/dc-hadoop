 ...
 * 天滚存输出的玩家当周游行情况
 * 输出：
 * statDate, appId, appVer, platform, channel, country, province, playerType, 
 * totalPlayers, totalLoginTimes, totalOnlineTime
 */
public class CHWeekUserHabitsMapper extends Mapper<LongWritable, Text, OutFieldsBaseModel, OutFieldsBaseModel> {
