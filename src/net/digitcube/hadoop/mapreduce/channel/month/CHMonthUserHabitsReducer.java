...
public class CHMonthUserHabitsReducer extends Reducer<OutFieldsBaseModel, OutFieldsBaseModel, OutFieldsBaseModel, OutFieldsBaseModel> {
	...
	protected void reduce(OutFieldsBaseModel key, Iterable<OutFieldsBaseModel> values, Context context) throws IOException, InterruptedException {
		...
		key.setSuffix(Constants.SUFFIX_CHANNEL_MONTH_HABITS);
