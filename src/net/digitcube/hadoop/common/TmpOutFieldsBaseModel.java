...
public class TmpOutFieldsBaseModel extends SuffixBase implements
	...
	public TmpOutFieldsBaseModel() {
	}

	public TmpOutFieldsBaseModel(String[] outFields) {
	...
	public String toString() {
		...
		for (int i = 0; i < outFields.length; i++) {
			...
			strBuf.append(",").append(outFields[i]);
		}
