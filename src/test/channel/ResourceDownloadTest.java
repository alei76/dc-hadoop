...
public class ResourceDownloadTest {
	...
	public void testMap() throws Exception {
		...
		// 多个输入源
		BufferedReader[] arr = {
				new BufferedReader(new FileReader("D:\\hadoop\\part-r-00001-DESelf_Channel_Res_Download")),
				new BufferedReader(new FileReader("D:\\hadoop\\part-r-00001-DESelf_Channel_Download_Result"))};
