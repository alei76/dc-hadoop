...
public class CHPagePathSumTest {
...
//	@Test
	public void testMapReduce() throws Exception {
		...
		// 多个输入源
		BufferedReader[] arr = { new BufferedReader(new FileReader("D:\\hadoop\\part-r-00001-DESelf_Channel_PageNavigation")) };
	...
	public void testMapReduceSum() throws Exception {
		System.out.println("MapReduce,Begin------------------------------------------------------------------");
		// 多个输入源
		BufferedReader[] arr = { new BufferedReader(new FileReader("D:\\hadoop\\part-r-00001-DESelf_Channel_PageNavigationSum")) };
		LongWritable longWritable = new LongWritable();
		String line = null;
		for (BufferedReader br : arr) {
			while (null != (line = br.readLine())) {
