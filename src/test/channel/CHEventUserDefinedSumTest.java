...
import net.digitcube.hadoop.mapreduce.channel.event.CHEventUserDefinedSumMapper;
import net.digitcube.hadoop.mapreduce.channel.event.CHEventUserDefinedSumReducer;
...
public class CHEventUserDefinedSumTest {
	...
	@Before
	public void setUp() {
		CHEventUserDefinedSumMapper map = new CHEventUserDefinedSumMapper();
		CHEventUserDefinedSumReducer reduce = new CHEventUserDefinedSumReducer();
	...
	public void testMap() throws Exception {
		...
		// 多个输入源
		BufferedReader[] arr = {
				new BufferedReader(new FileReader("D:\\hadoop\\part-r-00001-CHANNEL_EVENT_ATTR_STAT"))};
