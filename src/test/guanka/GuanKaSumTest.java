...
import net.digitcube.hadoop.mapreduce.guanka.GuanKaSumNewMapper;
import net.digitcube.hadoop.mapreduce.guanka.GuanKaSumNewReducer;
...
public class GuanKaSumTest {
	...
	@Before
	public void setUp() {
		GuanKaSumNewMapper map = new GuanKaSumNewMapper();
		GuanKaSumNewReducer reduce = new GuanKaSumNewReducer();
	...
	public void testMap() throws Exception {
		...
		// 多个输入源
		BufferedReader[] arr = {
				new BufferedReader(new FileReader("D:\\hdfs\\GuanKaFailReasonDist.txt"))/*, // GuanKaFailReasonDist.txt,GuanKaSum.txt
...
//	@Test
	public void testMapReduce() throws Exception {
		...
		// 多个输入源
		BufferedReader[] arr = {
				new BufferedReader(new FileReader("D:\\hdfs\\GuanKaFailReasonDist.txt"))/*,
				new BufferedReader(new FileReader("D:\\hadoop\\DESelf_App_Install.0317")),
				new BufferedReader(new FileReader("D:\\hadoop\\part-r-00001-DESelf_App_Launch"))*/};
		LongWritable longWritable = new LongWritable();
		String line = null;
