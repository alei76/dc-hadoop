...
import net.digitcube.hadoop.mapreduce.warehouse.WHUidRollingMapper;
import net.digitcube.hadoop.mapreduce.warehouse.WHUidRollingReducer;
...
public class WHUidRollingTest {
	...
	@Before
	public void setUp() {
		WHUidRollingMapper map = new WHUidRollingMapper();
		WHUidRollingReducer reduce = new WHUidRollingReducer();
