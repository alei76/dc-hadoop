...
public class WHAppListTest {
	...
	@Before
	public void setUp() {
		WarehouseAppListMapper map = new WarehouseAppListMapper();
		WarehouseAppListReducer reduce = new WarehouseAppListReducer();
	...
	public void testMapReduce() throws Exception {
		...
		// 多个输入源
		BufferedReader[] arr = {
				new BufferedReader(new FileReader("D:\\hadoop\\AppDetail.log"))/*,
