...
import net.digitcube.hadoop.tmp.CompareWHUidAndWHOnlineMapper;
import net.digitcube.hadoop.tmp.CompareWHUidAndWHOnlineReducer;
...
public class CompareWHUidAndWHOnlineTest {
	...
	@Before
	public void setUp() {
		CompareWHUidAndWHOnlineMapper map = new CompareWHUidAndWHOnlineMapper();
		CompareWHUidAndWHOnlineReducer reduce = new CompareWHUidAndWHOnlineReducer();
