...
import net.digitcube.hadoop.mapreduce.warehouse.WHOnlineDetailMapper;
import net.digitcube.hadoop.mapreduce.warehouse.WHOnlineDetailReducer;
...
public class WHOnlineDetailTest {
	...
	@Before
	public void setUp() {
		WHOnlineDetailMapper map = new WHOnlineDetailMapper();
		WHOnlineDetailReducer reduce = new WHOnlineDetailReducer();
	...
	public void testMapReduce() throws Exception {
		...
		// 多个输入源
		BufferedReader[] arr = { new BufferedReader(new FileReader("D:\\hdfs\\warehouse\\online.log.0429")) };
		...
		for (Pair<OutFieldsBaseModel, NullWritable> pair : onlineList) {
			String lin = pair.getFirst().toString() + "\t" + pair.getSecond();
