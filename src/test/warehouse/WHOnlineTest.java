...
import net.digitcube.hadoop.mapreduce.warehouse.WarehouseOnlineMapper;
import net.digitcube.hadoop.mapreduce.warehouse.WarehouseOnlineReducer;
...
public class WHOnlineTest {
	...
	@Before
	public void setUp() {
		WarehouseOnlineMapper map = new WarehouseOnlineMapper();
		WarehouseOnlineReducer reduce = new WarehouseOnlineReducer();
	...
	public void testMapReduce() throws Exception {
		...
		// 多个输入源
		BufferedReader[] arr = { new BufferedReader(new FileReader("D:\\hdfs\\warehouse\\online.log")) };
