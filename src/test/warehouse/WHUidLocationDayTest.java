...
import net.digitcube.hadoop.mapreduce.warehouse.WHUidLocationDayMapper;
import net.digitcube.hadoop.mapreduce.warehouse.WHUidLocationDayReducer;
...
public class WHUidLocationDayTest {
	...
	@Before
	public void setUp() {
		WHUidLocationDayMapper map = new WHUidLocationDayMapper();
		WHUidLocationDayReducer reduce = new WHUidLocationDayReducer();
	...
	public void testMapReduce() throws Exception {
		...
		// 多个输入源
		BufferedReader[] arr = { new BufferedReader(new FileReader("D:\\hdfs\\warehouse\\wh_online_detail.log")) };
