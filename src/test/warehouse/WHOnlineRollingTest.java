...
import net.digitcube.hadoop.mapreduce.warehouse.WHOnlineRollingMapper;
import net.digitcube.hadoop.mapreduce.warehouse.WHOnlineRollingReducer;
...
public class WHOnlineRollingTest {
	...
	@Before
	public void setUp() {
		WHOnlineRollingMapper map = new WHOnlineRollingMapper();
		WHOnlineRollingReducer reduce = new WHOnlineRollingReducer();
