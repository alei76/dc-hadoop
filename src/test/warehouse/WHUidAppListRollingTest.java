...
import net.digitcube.hadoop.mapreduce.warehouse.WHUidAppListRollingMapper;
import net.digitcube.hadoop.mapreduce.warehouse.WHUidAppListRollingReducer;
...
public class WHUidAppListRollingTest {
	...
	public void testMapReduce() throws Exception {
		...
		// 多个输入源
		BufferedReader[] arr = { new BufferedReader(new FileReader("D:\\hdfs\\warehouse\\appdetail.log")) };
