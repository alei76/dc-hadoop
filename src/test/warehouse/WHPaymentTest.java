...
import net.digitcube.hadoop.mapreduce.warehouse.WarehousePaymentMapper;
import net.digitcube.hadoop.mapreduce.warehouse.WarehousePaymentReducer;
...
public class WHPaymentTest {
	...
	@Before
	public void setUp() {
		WarehousePaymentMapper map = new WarehousePaymentMapper();
		WarehousePaymentReducer reduce = new WarehousePaymentReducer();
