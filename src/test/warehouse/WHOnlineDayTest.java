...
import net.digitcube.hadoop.mapreduce.warehouse.WHOnlineDayMapper;
import net.digitcube.hadoop.mapreduce.warehouse.WHOnlineDayReducer;
...
public class WHOnlineDayTest {
	...
	@Before
	public void setUp() {
		WHOnlineDayMapper map = new WHOnlineDayMapper();
		WHOnlineDayReducer reduce = new WHOnlineDayReducer();
	...
	public void testMapReduce() throws Exception {
		...
		// 多个输入源
		BufferedReader[] arr = { new BufferedReader(new FileReader("D:\\hdfs\\warehouse\\online_detail")) };
