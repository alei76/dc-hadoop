...
import net.digitcube.hadoop.mapreduce.warehouse.WHUidStatDayMapper;
import net.digitcube.hadoop.mapreduce.warehouse.WHUidStatDayReducer;
...
public class WHUidStatDayTest {
	...
	@Before
	public void setUp() {
		WHUidStatDayMapper map = new WHUidStatDayMapper();
		WHUidStatDayReducer reduce = new WHUidStatDayReducer();
