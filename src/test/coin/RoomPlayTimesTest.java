...
public class RoomPlayTimesTest {

	private MapReduceDriver<LongWritable, Text, TmpOutFieldsBaseModel, IntWritable, TmpOutFieldsBaseModel, NullWritable> eventDriver;
	
	@Before
	public void setUp() {
		RoomPlayTimesForCherryMapper map = new RoomPlayTimesForCherryMapper();
		RoomPlayTimesForCherryReducer reduce = new RoomPlayTimesForCherryReducer();
	...
	public void testAcuPcuCntHour() throws Exception {
		...
		BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\Administrator\\Desktop\\roomdata.0311"));
