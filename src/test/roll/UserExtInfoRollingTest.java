...
public class UserExtInfoRollingTest {
	...
	@Before
	public void setUp() {
		UserInfoRollingHourMapper map = new UserInfoRollingHourMapper();
		UserInfoRollingHourReducer reduce = new UserInfoRollingHourReducer();
	...
	public void testAcuPcuCntHour() throws Exception {
		...
		BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\Administrator\\Desktop\\payhour.0805"));
