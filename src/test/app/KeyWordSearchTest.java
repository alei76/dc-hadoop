...
public class KeyWordSearchTest {
	...
	private MapReduceDriver<LongWritable, Text, OutFieldsBaseModel, Text, OutFieldsBaseModel, OutFieldsBaseModel> eventDriver;
	
	@Before
	public void setUp() {
		KeyWordSearchStatMapper map = new KeyWordSearchStatMapper();
		KeyWordSearchStatReducer reduce = new KeyWordSearchStatReducer();
	...
	public void testAcuPcuCntHour() throws Exception {
		...
		BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\Administrator\\Desktop\\part-r-00000-DESelf_APP_SOURCE"));
